                      ...
                      ?>
                        <li><a href="#"><i class="fa fa-tablet"></i><span><?php echo $Lan['Bulk_SMS']; ?></span></a>
                            <ul class="sub-menu">
                                ...
                                <li  <?php  if($url=='purchase-sms-plan.php' OR $url=='view-price-plan-feature.php'){echo 'class="active"';} ?>><a href="purchase-sms-plan.php"><?php echo $Lan['Purchase_SMS_Plan'];?></a></li>
                               </ul>
                        </li>
