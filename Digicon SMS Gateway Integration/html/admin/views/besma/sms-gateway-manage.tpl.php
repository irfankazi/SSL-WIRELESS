                    ...
                    <div class="block-flat">
                        ...
                        <div class="content">
                            ...
                            <form class="form-horizontal group-border-dashed" role="form"  parsley-validate novalidate action="setup-sms-api.php?_sgid=<?php echo $cmd; ?>" method="post">
                                ...
                                <div class="form-group">
                                    <label for="gname" class="col-sm-3 control-label"><?php echo $Lan['Per_SMS_Credit']; ?></label>
                                    <div class="col-sm-7">
                                        <input type="text" required  class="form-control" id="sms_credit" placeholder="<?php echo $Lan['Per_SMS_Credit']; ?>" name="sms_credit" value="<?php echo $d['credit']; ?>">
                                    </div>
                                </div>
