        ...
        <form class="form-horizontal group-border-dashed" action="edit.administrator-role-manage.php?_rid=<?php echo $roleid; ?>" style="border-radius: 0px;" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="radio">
                        <label> <input type="checkbox" name="perms[]" value="50"  <?php if (permission($roleid,'51')) { echo 'checked="checked"'; } ?> class="icheck"> <?php echo $Lan['send_schedule_sms']; ?></label>
                    </div>


                    <div class="radio">
                        <label> <input type="checkbox" name="perms[]" value="50"  <?php if (permission($roleid,'52')) { echo 'checked="checked"'; } ?> class="icheck"> <?php echo $Lan['schedule_sms_from_file']; ?></label>
                    </div>
