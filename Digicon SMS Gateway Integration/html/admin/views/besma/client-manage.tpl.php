...
?>
    ...
    <div class="md-modal colored-header custom-width md-effect-9" id="form-green">
        <form class="form-horizontal group-border-dashed" autocomplete="off" action="single-email-send.php?_clid=<?php echo $cmd; ?>" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate>
            <div class="md-content">
                <div class="modal-header">
