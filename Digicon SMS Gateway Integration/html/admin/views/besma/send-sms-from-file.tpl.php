                ...
                <div class="col-md-12 fuelux">
                    <div class="block-wizard">
                        ...
                        <div class="step-content">
                            <form class="form-horizontal group-border-dashed" action="sms-send-from-file.php" method="post" data-parsley-namespace="data-parsley-" data-parsley-validate novalidate enctype="multipart/form-data">
