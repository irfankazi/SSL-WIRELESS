...
?>
    ...
    elseif(!isset($_POST["data_update"]) || !isset($_POST['cancel_update']))
    {
        ...
        <center>
        <table align="center">
            <tr><td><input name="data_update" type="submit" align="center" value=" Update "/><input name="cancel_update" type="submit" align="center" value=" Cancel "/></td></tr>
        </table>
        </center>
...
?>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        if(isset($_POST['data_update']))
        {
            ...
            if(mysql_query($sql_for_update_out_telco) && mysql_query($sql_for_update_map_user))
            {
                ...
                echo "<center><p color=\"green\" align=\"center\">Successfully Updated</p></center>";
            }
            elseif(mysql_query($sql_for_update_out_telco))
            {
                ...
                echo "<center><p color=\"green\" align=\"center\">OUT TELCO Updated</p></center>  ";
            }
            elseif(mysql_query($sql_for_update_map_user))
            {
                ...
                echo "<center><p color=\"green\" align=\"center\">MAP USER Updated</p> </center> ";
            }
            else
            {
                echo "<center><p color=\"red\" align=\"center\">No Update Occured</p> </center>";
            }
        ?>
        <br>
        <center><a href="operations.php"><input name="back_to_search_masking" type="button" align="center" value=" Back "/></center>
            <input type="hidden" name="request_from" value="<?php echo $_POST["request_from"]; ?>">
            <input type="hidden" name="update_out_telcoGRAMEEN" value="<?php echo $_POST["update_out_telcoGRAMEEN"]; ?>">
            <input type="hidden" name="update_out_telcoBANGLALINK" value="<?php echo $_POST["update_out_telcoBANGLALINK"]; ?>">
            <input type="hidden" name="update_out_telcoAKTEL" value="<?php echo $_POST["update_out_telcoAKTEL"]; ?>">
    ...
    <?php
        ...
        {
            echo "<center><table><tr><td><p color=\"red\" align=\"center\">Update Cancelled</p></td></tr>";
            ?>
    <tr><td><a href="operations.php"><input name="back_to_search_masking" type="button" align="center" value=" Back "/></a></td></tr></table></center>
            <?php
        }
}
?>
